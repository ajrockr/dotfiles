...
bar {
	colors {
		background 	   $bg-color
		statusline 	   $yellow-color
		focused_statusline $yellow-color
		focused_separator  $bg-color
		
		focused_workspace  $bg-color $fg-color    $orange-color
		active_workspace   $bg-color $fg-color $yellow-color
		inactive_workspace $bg-color $bg-color     $yellow-color
		urgent_workspace   $bg-color $red-color      $orange-color
	}
